...
namespace CourseworkExercise3 {
    ...
    public partial class addressBookDataSet : global::System.Data.DataSet {
        ...
        public partial class ContactsDataTable : global::System.Data.TypedTableBase<ContactsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ContactsRow AddContactsRow(string firstName, string lastName, string emailAddress) {
...
namespace CourseworkExercise3.addressBookDataSetTableAdapters {
    ...
    public partial class ContactsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Contacts] ([firstName], [lastName], [emailAddress]) VALUES (@f" +
                "irstName, @lastName, @emailAddress);\r\nSELECT Id, firstName, lastName, emailAddre" +
                "ss FROM Contacts WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Contacts] SET [firstName] = @firstName, [lastName] = @lastName, [em" +
                "ailAddress] = @emailAddress WHERE (([Id] = @Original_Id));\r\nSELECT Id, firstName" +
                ", lastName, emailAddress FROM Contacts WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CourseworkExercise3.Properties.Settings.Default.addressBookConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, firstName, lastName, emailAddress FROM dbo.Contacts";
        ...
        public virtual int Fill(addressBookDataSet.ContactsDataTable dataTable) {
        ...
        public virtual addressBookDataSet.ContactsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            addressBookDataSet.ContactsDataTable dataTable = new addressBookDataSet.ContactsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(addressBookDataSet.ContactsDataTable dataTable) {
        ...
        public virtual int Update(string firstName, string lastName, string emailAddress, int Original_Id, int Id) {
            if ((firstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstName, string lastName, string emailAddress, int Original_Id) {
            return this.Update(firstName, lastName, emailAddress, Original_Id, Original_Id);
        }
    }
